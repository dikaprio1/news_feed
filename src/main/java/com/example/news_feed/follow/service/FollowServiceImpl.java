...
public class FollowServiceImpl implements FollowService{
    ...
    public void registerFollow(FollowRequestDto followRequestDto, HttpServletRequest request) {
        ...
        // followRequestDto에서 받아온 email이 내 email에 follow 되어 있는지 확인
        //
        Optional<Follow> isfollowing = followRepository.findByFollowerIdAndFollowingId(myId, followId);
        ...
        // 존재한다면 팔로우취소(언팔로우)
            ...
            followRepository.delete(isfollowing.get());
        }
...
// 세션에서 내 이메일 조회
    ...
    // Follow 취소 <- registerFollow에서 가능할 것 같음
